...
* Roughly how much time you spent on this HW so far: Probably about 4-5 hours
* The URL of the RPubs published URL [here](http://rpubs.com/ahotvedt/213269).
* What gave you the most trouble: Question #3! I have only gotten part of the way through it for this pre-submit
...
southwest_flights <- flights_less %>% 
  filter(carrier == "WN")
